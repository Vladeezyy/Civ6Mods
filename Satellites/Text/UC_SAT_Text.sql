...
VALUES	('LOC_PROJECT_LAUNCH_EARTH_SATELLITE_DESCRIPTION_JNR_UC',				'Space Race project which launches a small satellite into orbit. Marks the first step towards the Science Victory.[NEWLINE][NEWLINE]One-time reward of +100 [ICON_GreatScientist] Great Scientist and +100 [ICON_GreatEngineer] Great Engineer points.'),
		...
		('LOC_PROJECT_JNR_SATELLITE_OBSERVATION_DESCRIPTION',					'Space project which launches a satellite constellation into orbit.[NEWLINE]Reveals the geography of any unexplored corner of the world.'),
		...
		('LOC_PROJECT_JNR_SATELLITE_ESPIONAGE_DESCRIPTION',						'Space project which launches a satellite constellation into orbit.[NEWLINE]+1 Level of diplomatic visibility with all other civilizations.[NEWLINE]Your Spy level is increased by 1 for offensive operations.[NEWLINE][NEWLINE]Requires having a Tier 3 Government Plaza building in your empire.'),
		...
		('LOC_PROJECT_JNR_SATELLITE_MILITARY_DESCRIPTION',						'Space project which launches a satellite constellation into orbit.[NEWLINE]All units with anti-air capabilities gain +10 [ICON_AntiAir_Large] Anti-Air Strength.[NEWLINE][NEWLINE]Requires having at least three Tier 3 Encampment buildings in your empire.'),
		...
		('LOC_PROJECT_JNR_SATELLITE_WEATHER_DESCRIPTION',						'Space project which launches a satellite constellation into orbit.[NEWLINE]+1 [ICON_Food] Food to all improvements in your empire with a [ICON_Food] Food yield bonus.[NEWLINE]+1 Diplomatic Victory point.[NEWLINE][NEWLINE]Requires having at least three Tier 3 Campus buildings in your empire.'),
		...
		('LOC_PROJECT_JNR_SATELLITE_BROADCAST_DESCRIPTION',						'Repeatable Space project which launches a satellite into orbit.[NEWLINE]+5% [ICON_Tourism] Tourism across your empire.[NEWLINE][NEWLINE]Requires having at least three Tier 3 Theater Square buildings in your empire.'),
		...
		('LOC_PROJECT_JNR_SATELLITE_COMMUNICATION_DESCRIPTION',					'Repeatable Space project which launches a satellite into orbit.[NEWLINE]+2 [ICON_ENVOY] Envoys when completed.[NEWLINE][NEWLINE]Requires having at least three Tier 3 Commercial Hub buildings in your empire.'),
		...
		('LOC_PROJECT_JNR_SATELLITE_SOLAR_POWER_DESCRIPTION',					'Repeatable Space project which launches a satellite into orbit.[NEWLINE]Provides the city +9 [ICON_Power] Power from renewable solar sources.[NEWLINE][NEWLINE]Requires having at least three Power Plant buildings (any type) in your empire.'),
		...
		('LOC_ABILITY_JNR_SAT_MILITARY_AIR_STRENGTH_BUFF_NAME',					'Military Satellite'),
		('LOC_ABILITY_JNR_SAT_MILITARY_AIR_STRENGTH_BUFF_DESCRIPTION',			'+10 [ICON_AntiAir_Large] Anti-Air Strength from Military Satellite.'),
		('LOC_ABILITY_JNR_SAT_MILITARY_AIR_STRENGTH_BUFF_MODIFIER_DESCRIPTION',	'+{1_Amount} from Military Satellite'),
		...
		('LOC_POWER_REQUIREMENT_MISC',											'Miscellaneous'),
		('LOC_HUD_POPUP_PROJECT_CREATED_TITLE',									'A Space Project Has Been Completed!');
		
UPDATE LocalizedText SET Text = REPLACE(Text, 'Tier 3', 'Tier 4')	WHERE Tag='LOC_PROJECT_JNR_SATELLITE_WEATHER_DESCRIPTION'	AND EXISTS (SELECT * FROM LocalizedText WHERE Tag='LOC_BUILDING_JNR_EDUCATION_NAME');
UPDATE LocalizedText SET Text = REPLACE(Text, 'Tier 3', 'Tier 4')	WHERE Tag='LOC_PROJECT_JNR_SATELLITE_BROADCAST_DESCRIPTION'	AND EXISTS (SELECT * FROM LocalizedText WHERE Tag='LOC_BUILDING_JNR_MEDIA_CENTER_NAME');
--------------------------------------------------------------