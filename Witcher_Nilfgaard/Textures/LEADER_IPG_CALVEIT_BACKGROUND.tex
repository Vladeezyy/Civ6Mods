...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\Gabriele\Pictures\Gwent Assets\5-Civilizations\Nilfgaard\leader\LEADER_IPG_CALVEIT_BACKGROUND.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1620050195</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_IPG_CALVEIT_BACKGROUND.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_IPG_CALVEIT_BACKGROUND"/>
	<m_Description text=""/>
	<m_Tags>
