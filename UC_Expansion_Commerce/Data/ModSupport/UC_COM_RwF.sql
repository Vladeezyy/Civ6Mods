...
INSERT OR IGNORE INTO ModifierArguments
		(ModifierId,										Name,			Value)
SELECT	'JFD_FREE_MARKET_MINT_GOLD_UC_JNR',					'BuildingType',	'BUILDING_JNR_MINT'					FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';

INSERT OR IGNORE INTO ModifierArguments
		(ModifierId,										Name,			Value)
SELECT	'JFD_FREE_MARKET_WAYSTATION_GOLD_UC_JNR',			'BuildingType',	'BUILDING_JNR_WAYSTATION'			FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';
