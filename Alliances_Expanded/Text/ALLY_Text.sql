...
VALUES
	...
	(
		...
		'Открывает возможность Строителю построить Траулер.[NEWLINE]Дублирует ресурсы с соседних плиток, добавляет их на плитку Траулера и предоставляет её ресурсы в [ICON_Capital] Столицу.'
	),
	(
		"ru_RU",
	...
	(
		...
		'+4 очков Дипломатической победы при строительстве. Все ваши города в пределах 6 плиток всегда имеют 100% Лояльности. +2 очка альянса за ход с каждым союзником.[NEWLINE][NEWLINE]Должен быть построен на побережье, рядом с землёй и портом.'
	),
	(
		"ru_RU",
