...
VALUES
	...
	(
		...
		'+4 очков Дипломатической победы при строительстве. Все ваши города в пределах 6 клеток всегда имеют 100% Лояльности. +2 очка альянса за ход с каждым союзником.[NEWLINE][NEWLINE]Должен быть построен на побережье, рядом с землёй и портом.'
	),
	(
		"ru_RU",
