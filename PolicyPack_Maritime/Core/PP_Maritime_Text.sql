...
VALUES
    ...
    ('LOC_POLICY_JNR_NATURAL_HARBORS_DESCRIPTION', '+1 [ICON_Food] Еды и +1 [ICON_Production] Производства на клетках побережья или озера, прилегающих к центрам городов.'),
    ...
    ('LOC_POLICY_JNR_SCUBA_DIVING_DESCRIPTION', '+2 Привлекательности к клеткам, прилегающим к морским особенностям.'),
    ...
    ('LOC_POLICY_JNR_VIRTUAL_BEACHES_DESCRIPTION', '+1 [ICON_Amenities] Довольство и +10 [ICON_Tourism] Туризма в городах с Барьерами от Наводнений.'),
