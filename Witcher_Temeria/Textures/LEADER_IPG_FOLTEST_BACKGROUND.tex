...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\Gabriele\Pictures\Gwent Assets\5-Civilizations\Temeria\leader\LEADER_FOLTEST_LOADING_BG.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>180799900</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_IPG_FOLTEST_BACKGROUND.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_IPG_FOLTEST_BACKGROUND"/>
	<m_Description text=""/>
	<m_Tags>
