...
UPDATE Buildings SET Description='LOC_BUILDING_JNR_HAMMER_WORKS_DESCRIPTION_UC_PRD' WHERE BuildingType='BUILDING_JNR_HAMMER_WORKS' AND EXISTS (SELECT * FROM Buildings WHERE BuildingType='BUILDING_JNR_IZ_WATER_MILL');
--------------------------------------------------------------
...
INSERT OR IGNORE INTO BuildingPrereqs
		(Building,						PrereqBuilding)
SELECT	'BUILDING_JNR_HAMMER_WORKS',	'BUILDING_JNR_IZ_WATER_MILL'
FROM	Buildings WHERE EXISTS (SELECT * FROM BUILDINGS WHERE BuildingType='BUILDING_JNR_IZ_WATER_MILL');
