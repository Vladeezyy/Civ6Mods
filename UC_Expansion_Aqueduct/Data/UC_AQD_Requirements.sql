...
VALUES	('REQUIRES_CITY_HAS_AQUEDUCT_JNR',				'REQUIREMENT_CITY_HAS_DISTRICT'),
		...
		('REQUIRES_PLOT_ADJACENT_TO_NEIGHBORHOOD_JNR',	'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES'),
...
VALUES	('REQUIRES_CITY_HAS_AQUEDUCT_JNR',				'DistrictType',		'DISTRICT_AQUEDUCT'),
		...
		('REQUIRES_PLOT_ADJACENT_TO_NEIGHBORHOOD_JNR',	'DistrictType',		'DISTRICT_NEIGHBORHOOD'),
...
VALUES	('CITY_HAS_AQUEDUCT_JNR',											'REQUIREMENTSET_TEST_ALL'),
		('DISTRICT_IS_AQUEDUCT_BREATHTAKING_JNR',							'REQUIREMENTSET_TEST_ALL'),
		...
		('PLOT_IS_FOOD_IMPROVEMENT_WATER_WORKS_ADJACENT_REQUIREMENTS_JNR',	'REQUIREMENTSET_TEST_ALL'),
		('PLOT_IS_RESIDENTIAL_ADJACENT_REQUIREMENTS_JNR',					'REQUIREMENTSET_TEST_ANY'),
		('CITY_HAS_POPULATION_5_JNR',										'REQUIREMENTSET_TEST_ALL'),
		('CITY_HAS_POPULATION_10_JNR',										'REQUIREMENTSET_TEST_ALL'),
		('CITY_HAS_POPULATION_15_JNR',										'REQUIREMENTSET_TEST_ALL'),
		('CITY_HAS_POPULATION_20_JNR',										'REQUIREMENTSET_TEST_ALL'),
		('CITY_HAS_POPULATION_25_JNR',										'REQUIREMENTSET_TEST_ALL'),
		('CITY_HAS_POPULATION_30_JNR',										'REQUIREMENTSET_TEST_ALL'),
...
VALUES	('CITY_HAS_AQUEDUCT_JNR',											'REQUIRES_CITY_HAS_AQUEDUCT_JNR'),
		('DISTRICT_IS_AQUEDUCT_BREATHTAKING_JNR',							'REQUIRES_DISTRICT_IS_AQUEDUCT'),
		('DISTRICT_IS_AQUEDUCT_BREATHTAKING_JNR',							'REQUIRES_PLOT_BREATHTAKING_APPEAL'),
		...
		('PLOT_IS_FOOD_IMPROVEMENT_WATER_WORKS_ADJACENT_REQUIREMENTS_JNR',	'REQUIRES_PLOT_HAS_FOOD_IMPROVEMENT_JNR'),
		('PLOT_IS_FOOD_IMPROVEMENT_WATER_WORKS_ADJACENT_REQUIREMENTS_JNR',	'REQUIRES_PLOT_IS_WATER_WORKS_ADJACENT_JNR'),
		('PLOT_IS_RESIDENTIAL_ADJACENT_REQUIREMENTS_JNR',					'REQUIRES_PLOT_ADJACENT_TO_AQUEDUCT'),
		('PLOT_IS_RESIDENTIAL_ADJACENT_REQUIREMENTS_JNR',					'REQUIRES_PLOT_ADJACENT_TO_DAM_JNR'),
		('PLOT_IS_RESIDENTIAL_ADJACENT_REQUIREMENTS_JNR',					'REQUIRES_PLOT_ADJACENT_TO_CANAL_JNR'),
		('PLOT_IS_RESIDENTIAL_ADJACENT_REQUIREMENTS_JNR',					'REQUIRES_PLOT_ADJACENT_TO_NEIGHBORHOOD_JNR'),
		('CITY_HAS_POPULATION_5_JNR',										'REQUIRES_POPULATION_5_JNR'),
		('CITY_HAS_POPULATION_10_JNR',										'REQUIRES_POPULATION_10_JNR'),
		('CITY_HAS_POPULATION_15_JNR',										'REQUIRES_POPULATION_15_JNR'),
		('CITY_HAS_POPULATION_20_JNR',										'REQUIRES_POPULATION_20_JNR'),
		('CITY_HAS_POPULATION_25_JNR',										'REQUIRES_POPULATION_25_JNR'),
		('CITY_HAS_POPULATION_30_JNR',										'REQUIRES_POPULATION_30_JNR'),
