...
VALUES	('JNR_AQUEDUCT_CONSTRUCTION_COST_ORCHARD',		'MODIFIER_SINGLE_CITY_ADJUST_BUILDING_PRODUCTION',		'AQUEDUCT_DISCOUNT_ORCHARD_REQUIREMENTS_JNR'),			-- District
		...
		('JNR_BATHHOUSE_FAITH_POPULATION_5',			'MODIFIER_BUILDING_YIELD_CHANGE',						'CITY_HAS_POPULATION_5_JNR'),							-- Building
		('JNR_BATHHOUSE_FAITH_POPULATION_10',			'MODIFIER_BUILDING_YIELD_CHANGE',						'CITY_HAS_POPULATION_10_JNR'),							-- Building
		('JNR_BATHHOUSE_FAITH_POPULATION_15',			'MODIFIER_BUILDING_YIELD_CHANGE',						'CITY_HAS_POPULATION_15_JNR'),							-- Building
		('JNR_BATHHOUSE_FAITH_POPULATION_20',			'MODIFIER_BUILDING_YIELD_CHANGE',						'CITY_HAS_POPULATION_20_JNR'),							-- Building
		('JNR_BATHHOUSE_FAITH_POPULATION_25',			'MODIFIER_BUILDING_YIELD_CHANGE',						'CITY_HAS_POPULATION_25_JNR'),							-- Building
		('JNR_BATHHOUSE_FAITH_POPULATION_30',			'MODIFIER_BUILDING_YIELD_CHANGE',						'CITY_HAS_POPULATION_30_JNR'),							-- Building
...
VALUES	('JNR_HARDENED_STEEL_COMBAT_STRENGTH',			'Preview',	'+{1_Amount} {LOC_ABILITY_JNR_HARDENED_STEEL_NAME}');
--------------------------------------------------------------
...
--------------------------------------------------------------
DELETE FROM GovernorPromotionModifiers WHERE GovernorPromotionType='GOVERNOR_PROMOTION_INFRASTRUCTURE' AND ModifierId='INFRASTRUCTURE_FASTER_SEWER_CONSTRUCTION';
--------------------------------------------------------------
