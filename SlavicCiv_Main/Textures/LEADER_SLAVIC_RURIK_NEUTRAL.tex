...
<AssetObjects..TextureInstance>
	...
	<m_CookParams>
		<m_Values>
			...
			<Element class="AssetObjects..IntValue">
				<m_nValue>592</m_nValue>
				<m_ParamName text="TargetWidth"/>
			</Element>
			<Element class="AssetObjects..IntValue">
				<m_nValue>1001</m_nValue>
	...
	<m_SourceFilePath text="//civ6/main/SlavicCiv_Main\Textures\LEADER_SLAVIC_RURIK_NEUTRAL.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>909313629</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_SLAVIC_RURIK_NEUTRAL.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_SLAVIC_RURIK_NEUTRAL"/>
	<m_Description text=""/>
	<m_Tags>
