...
<AssetObjects..GeometryInstance>
	...
	<m_Bones>
		<Element text="ChristmasIsland_Decal"/>
		<Element text="NWON_BarrierReef_Decal"/>
	</m_Bones>
	<m_ModelName text="ChristmasIsland_Decal"/>
	...
	<m_DataFiles>
		<Element>
			<m_ID text="GR2"/>
			<m_RelativePath text="NWON_Christmas_Island.fgx"/>
		</Element>
	</m_DataFiles>
	<m_Name text="NWON_Christmas_Island"/>
	<m_Description text="christmasislandHM"/>
	<m_Tags>
