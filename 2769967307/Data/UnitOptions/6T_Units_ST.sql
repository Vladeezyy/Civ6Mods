...
UPDATE Units SET PrereqTech='TECH_LASERS'				WHERE UnitType='UNIT_ROCKET_ARTILLERY';
--------------------------------------------------------------

-- Ranged - Fire Support
--------------------------------------------------------------
UPDATE Units SET PrereqTech='TECH_RIFLING'				WHERE UnitType='UNIT_DLV_GATLING_GUN';
...
UPDATE Units SET PrereqTech='TECH_GUIDANCE_SYSTEMS'		WHERE UnitType='UNIT_DLV_SELF_PROPELLED_ARTILLERY';
--------------------------------------------------------------
...
UPDATE Units SET PrereqTech='TECH_STIRRUPS'				WHERE UnitType='UNIT_KNIGHT';
UPDATE Units SET PrereqTech='TECH_STIRRUPS'				WHERE UnitType='UNIT_ARABIAN_MAMLUK';
UPDATE Units SET PrereqTech='TECH_STIRRUPS'				WHERE UnitType='UNIT_MALI_MANDEKALU_CAVALRY';
...
UPDATE Units SET PrereqTech='TECH_6T_OPTICS'			WHERE UnitType='UNIT_DLV_COG';
...
UPDATE Units SET PrereqTech='TECH_6T_COMPASS'			WHERE UnitType='UNIT_DLV_GALLEASS';
UPDATE Units SET StrategicResource=NULL					WHERE UnitType='UNIT_DLV_GALLEASS';
UPDATE Units_XP2 SET ResourceCost=0						WHERE UnitType='UNIT_DLV_GALLEASS';
