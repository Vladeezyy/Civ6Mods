...
VALUES	('ICON_BUILDING_ARENA',						'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',					0),
		...
		('ICON_BUILDING_JNR_CONVENTION',			'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',					2),
		('ICON_BUILDING_JNR_MARINA',				'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',					3),
		('ICON_BUILDING_JNR_CASINO',				'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',					4),
		('ICON_BUILDING_JNR_CRUISE_TERMINAL',		'ICON_ATLAS_JNR_UC_ENT_BUILDINGS',					5),
		...
		('ICON_BUILDING_JNR_CONVENTION_FOW',		'ICON_ATLAS_BUILDINGS_FOW',							39),
		...
		('ICON_BUILDING_JNR_CRUISE_TERMINAL_FOW',	'ICON_ATLAS_EXPANSION_1_DISTRICT_BUILDINGS_FOW',	10);
--------------------------------------------------------------
...
INSERT INTO IconAliases	
		(Name,							OtherName)
VALUES 	('ICON_POLICY_JNR_HASTILUDE',	'ICON_POLICY_MILITARY'),
		('ICON_POLICY_JNR_STATE_FAIRS',	'ICON_POLICY_ECONOMIC'),
		('ICON_POLICY_JNR_RED_LIST',	'ICON_POLICY_ECONOMIC');
--------------------------------------------------------------