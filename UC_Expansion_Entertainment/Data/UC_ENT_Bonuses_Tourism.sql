...
INSERT OR IGNORE INTO Building_TourismBombs_XP2
		(BuildingType,					TourismBombValue)
SELECT	'BUILDING_JNR_CONVENTION',		TourismBombValue
FROM	Building_TourismBombs_XP2
...
INSERT OR IGNORE INTO Building_TourismBombs_XP2
		(BuildingType,					TourismBombValue)
SELECT	'BUILDING_JNR_CRUISE_TERMINAL',	TourismBombValue
FROM	Building_TourismBombs_XP2
...
VALUES	('BUILDING_ARENA',					1,			'GREATWORKSLOT_MUSIC'),
		...
		('BUILDING_JNR_CONVENTION',			1,			'GREATWORKSLOT_MUSIC'),
		('BUILDING_JNR_CRUISE_TERMINAL',	1,			'GREATWORKSLOT_MUSIC');
--------------------------------------------------------------
...
VALUES	('JNR_ZOO_TOURISM',							'MODIFIER_PLAYER_DISTRICT_ADJUST_TOURISM_CHANGE',			NULL),
		...
		('JNR_MER_COFFEE_HOUSE_TOURISM',			'MODIFIER_PLAYER_DISTRICT_ADJUST_TOURISM_CHANGE',			NULL),
		...
		('JNR_CONVENTION_TOURISM_ADJACENCY',		'MODIFIER_JNR_CITY_DISTRICTS_ADJUST_YIELD_MODIFIER',		'DISTRICT_IS_ENTERTAINMENT_COMPLEX_POWERED_JNR'),
		('JNR_CRUISE_TERMINAL_TOURISM_ADJACENCY',	'MODIFIER_JNR_CITY_DISTRICTS_ADJUST_YIELD_MODIFIER',		'DISTRICT_IS_WATER_PARK_POWERED_JNR');
--------------------------------------------------------------
...
VALUES	('JNR_ZOO_TOURISM',								'Amount',		2),
		...
		('JNR_MER_COFFEE_HOUSE_TOURISM',			'Amount',		2),
		...
		('JNR_CONVENTION_TOURISM_ADJACENCY',		'YieldType',	'YIELD_GOLD'),
		('JNR_CONVENTION_TOURISM_ADJACENCY',		'Amount',		100),
		('JNR_CRUISE_TERMINAL_TOURISM_ADJACENCY',	'YieldType',	'YIELD_GOLD'),
		('JNR_CRUISE_TERMINAL_TOURISM_ADJACENCY',	'Amount',		100);
...
VALUES	('BUILDING_ZOO',					'JNR_ZOO_TOURISM'),
		...
		('BUILDING_JNR_CONVENTION',			'JNR_CONVENTION_TOURISM_ADJACENCY'),
		('BUILDING_JNR_CRUISE_TERMINAL',	'JNR_CRUISE_TERMINAL_TOURISM_ADJACENCY'),
		('BUILDING_AQUATICS_CENTER',		'STADIUM_10_POPULATION_TOURISM'),
		('BUILDING_AQUATICS_CENTER',		'STADIUM_20_POPULATION_TOURISM');
		
INSERT OR IGNORE INTO BuildingModifiers
		(BuildingType,						ModifierId)
SELECT	BuildingType,						'JNR_MER_COFFEE_HOUSE_TOURISM'
FROM	Buildings
