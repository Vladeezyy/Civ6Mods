...
UPDATE Beliefs SET Description='LOC_BELIEF_JNR_KHALWAT_DESCRIPTION_SAVANNAH'	WHERE BeliefType='BELIEF_JNR_KHALWAT'	AND EXISTS (SELECT * FROM Features WHERE FeatureType='FEATURE_JNR_SAVANNAH');
UPDATE Beliefs SET Description='LOC_BELIEF_WAT_DESCRIPTION_UC_JNR_SWAMP'		WHERE BeliefType='BELIEF_WAT'			AND EXISTS (SELECT * FROM Features WHERE FeatureType='FEATURE_JNR_SWAMP');
