...
-- PTOLEMAIC CLEOPATRA
--------------------------------------------------------------
UPDATE ModifierArguments SET Value=1 WHERE Name='Amount' AND ModifierId='CLEOPATRA_FLOODPLAINS_APPEAL';
UPDATE ModifierArguments SET Value=1 WHERE Name='Amount' AND ModifierId='CLEOPATRA_GRASS_FLOODPLAINS_APPEAL';
UPDATE ModifierArguments SET Value=1 WHERE Name='Amount' AND ModifierId='CLEOPATRA_PLAINS_FLOODPLAINS_APPEAL';
UPDATE ModifierArguments SET Value=1 WHERE Name='Amount' AND ModifierId='CLEOPATRA_TUNDRA_FLOODPLAINS_APPEAL';
--------------------------------------------------------------