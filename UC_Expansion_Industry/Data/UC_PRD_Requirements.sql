...
VALUES	('REQUIRES_INDUSTRIAL_ZONE_HAS_HIGH_ADJACENCY_JNR',	'REQUIREMENT_CITY_HAS_HIGH_ADJACENCY_DISTRICT'),
		('REQUIRES_CITY_HAS_IZ_WATER_MILL_JNR',				'REQUIREMENT_CITY_HAS_BUILDING'),
...
VALUES	('REQUIRES_INDUSTRIAL_ZONE_HAS_HIGH_ADJACENCY_JNR',	'DistrictType',		'DISTRICT_INDUSTRIAL_ZONE'),
		...
		('REQUIRES_CITY_HAS_IZ_WATER_MILL_JNR',				'BuildingType',		'BUILDING_JNR_IZ_WATER_MILL'),
...
VALUES	('INDUSTRIAL_ZONE_HAS_HIGH_ADJACENCY_JNR',	'REQUIRES_INDUSTRIAL_ZONE_HAS_HIGH_ADJACENCY_JNR'),
		('BUILDING_IS_INDUSTRIAL_TIER1_JNR',		'REQUIRES_CITY_HAS_IZ_WATER_MILL_JNR'),
		...
		('BUILDING_IS_INDUSTRIAL_TIER4_JNR',		'REQUIRES_CITY_HAS_COAL_POWER_PLANT'),
		('BUILDING_IS_INDUSTRIAL_TIER4_JNR',		'REQUIRES_CITY_HAS_FOSSIL_FUEL_POWER_PLANT'),
		('BUILDING_IS_INDUSTRIAL_TIER4_JNR',		'REQUIRES_CITY_HAS_POWER_PLANT'),
...
INSERT OR IGNORE INTO RequirementSetRequirements
		(RequirementSetId,							RequirementId)
SELECT	'BUILDING_IS_INDUSTRIAL_TIER4_JNR',			RequirementId
FROM	Requirements
WHERE	RequirementId='REQUIRES_CITY_HAS_POWERPLANT_RENEWABLE_JNR';
--------------------------------------------------------------
