...
VALUES	('GREAT_PERSON_INDIVIDUAL_JNR_ARCHIMEDES',				'LOC_GREAT_PERSON_INDIVIDUAL_JNR_ARCHIMEDES_NAME',				'GREAT_PERSON_CLASS_ENGINEER',	'ERA_CLASSICAL',	'M',	1,				'DISTRICT_INDUSTRIAL_ZONE'),
		('GREAT_PERSON_INDIVIDUAL_JNR_LI_BING',					'LOC_GREAT_PERSON_INDIVIDUAL_JNR_LI_BING_NAME',					'GREAT_PERSON_CLASS_ENGINEER',	'ERA_CLASSICAL',	'M',	1,				'DISTRICT_INDUSTRIAL_ZONE'),
		('GREAT_PERSON_INDIVIDUAL_JNR_MA_JUN',					'LOC_GREAT_PERSON_INDIVIDUAL_JNR_MA_JUN_NAME',					'GREAT_PERSON_CLASS_ENGINEER',	'ERA_CLASSICAL',	'M',	1,				'DISTRICT_CITY_CENTER'),
		('GREAT_PERSON_INDIVIDUAL_JNR_MARTINE_DE_BERTEREAU',	'LOC_GREAT_PERSON_INDIVIDUAL_JNR_MARTINE_DE_BERTEREAU_NAME',	'GREAT_PERSON_CLASS_ENGINEER',	'ERA_RENAISSANCE',	'F',	1,				'DISTRICT_CITY_CENTER');

UPDATE GreatPersonIndividuals SET EraType='ERA_CLASSICAL'	WHERE GreatPersonIndividualType='GREAT_PERSON_INDIVIDUAL_IMHOTEP'				AND NOT EXISTS	(SELECT * FROM GreatPersonIndividuals WHERE GreatPersonIndividualType='GREAT_PERSON_INDIVIDUAL_JNR_MARIA_HEBRAEA');
UPDATE GreatPersonIndividuals SET EraType='ERA_ANCIENT'		WHERE GreatPersonIndividualType='GREAT_PERSON_INDIVIDUAL_IMHOTEP'				AND EXISTS		(SELECT * FROM GreatPersonIndividuals WHERE GreatPersonIndividualType='GREAT_PERSON_INDIVIDUAL_JNR_MARIA_HEBRAEA');
UPDATE GreatPersonIndividuals SET EraType='ERA_ANCIENT'		WHERE GreatPersonIndividualType='GREAT_PERSON_INDIVIDUAL_JNR_MARIA_HEBRAEA';
...
SELECT	'JGP_FREE_LINCOLN_MILLS_ATTACH',	ModifierType,	RunOnce,	Permanent,	'BUILDING_IS_INDUSTRIAL_TIER1_JNR',		SubjectStackLimit
FROM	Modifiers
WHERE	ModifierId='JGP_FREE_LINCOLN_WORKSHOP_ATTACH';

INSERT INTO Modifiers
		(ModifierId,						ModifierType,	RunOnce,	Permanent,	SubjectRequirementSetId,				SubjectStackLimit)
SELECT	'JGP_FREE_LINCOLN_UNIT_MILLS',		ModifierType,	RunOnce,	Permanent,	SubjectRequirementSetId,				SubjectStackLimit
FROM	Modifiers
WHERE	ModifierId='JGP_FREE_LINCOLN_UNIT_WORKSHOP';
--------------------------------------------------------------
...
INSERT INTO ModifierArguments
		(ModifierId,						Name,						Value)
SELECT	'JGP_FREE_LINCOLN_MILLS_ATTACH',	'ModifierId',				'JGP_FREE_LINCOLN_UNIT_MILLS'		
FROM	ModifierArguments
WHERE	ModifierId='JGP_FREE_LINCOLN_WORKSHOP_ATTACH' AND Name='ModifierId';

INSERT INTO ModifierArguments
		(ModifierId,						Name,						Value)
SELECT	'JGP_FREE_LINCOLN_UNIT_MILLS',		'UnitPromotionClassType',	Value
FROM	ModifierArguments
WHERE	ModifierId='JGP_FREE_LINCOLN_UNIT_WORKSHOP' AND Name='UnitPromotionClassType';

INSERT INTO ModifierArguments
		(ModifierId,						Name,						Value)
SELECT	'JGP_FREE_LINCOLN_UNIT_MILLS',		'ModifierId',				Value
FROM	ModifierArguments
WHERE	ModifierId='JGP_FREE_LINCOLN_UNIT_WORKSHOP' AND Name='ModifierId';
--------------------------------------------------------------
...
SELECT	'TRAIT_LEADER_LINCOLN',	ModifierId
FROM	Modifiers
WHERE	ModifierId='JGP_FREE_LINCOLN_MILLS_ATTACH';
--------------------------------------------------------------
...
-- Modifiers
--------------------------------------------------------------
UPDATE Modifiers SET SubjectRequirementSetId='BUILDING_IS_INDUSTRIAL_TIER1_JNR'	WHERE ModifierId='VICTORIA_PRODUCTION_WORKSHOP';
UPDATE Modifiers SET SubjectRequirementSetId='BUILDING_IS_INDUSTRIAL_TIER2_JNR'	WHERE ModifierId='VICTORIA_PRODUCTION_FACTORY';
UPDATE Modifiers SET SubjectRequirementSetId='BUILDING_IS_INDUSTRIAL_TIER3_JNR'	WHERE ModifierId='VICTORIA_PRODUCTION_POWER_PLANT';

-- INSERT INTO Modifiers
		-- (ModifierId,						ModifierType,							SubjectRequirementSetId)
-- SELECT	'VICTORIA_PRODUCTION_MILLS_JNR',	ModifierType,							'BUILDING_IS_INDUSTRIAL_TIER2_JNR'
-- FROM	Modifiers
-- WHERE	ModifierId='VICTORIA_PRODUCTION_WORKSHOP';

-- INSERT INTO Modifiers
		-- (ModifierId,						ModifierType,							SubjectRequirementSetId)
-- SELECT	'VICTORIA_PRODUCTION_PRODUCT_JNR',	ModifierType,							'BUILDING_IS_INDUSTRIAL_TIER2_JNR'
-- FROM	Modifiers
-- WHERE	ModifierId='VICTORIA_PRODUCTION_WORKSHOP';

-- UPDATE Modifiers SET SubjectRequirementSetId='BUILDING_IS_INDUSTRIAL_TIER2_JNR'	WHERE ModifierId='VICTORIA_PRODUCTION_WORKSHOP';
-- UPDATE Modifiers SET SubjectRequirementSetId='BUILDING_IS_INDUSTRIAL_TIER3_JNR'	WHERE ModifierId='VICTORIA_PRODUCTION_FACTORY';
-- UPDATE Modifiers SET SubjectRequirementSetId='BUILDING_IS_INDUSTRIAL_TIER4_JNR'	WHERE ModifierId='VICTORIA_PRODUCTION_POWER_PLANT';
-- --------------------------------------------------------------

-- -- ModifierArguments
-- --------------------------------------------------------------
-- UPDATE ModifierArguments SET Value=5 WHERE ModifierId='VICTORIA_PRODUCTION_WORKSHOP';
-- UPDATE ModifierArguments SET Value=5 WHERE ModifierId='VICTORIA_PRODUCTION_FACTORY';
-- UPDATE ModifierArguments SET Value=5 WHERE ModifierId='VICTORIA_PRODUCTION_POWER_PLANT';

-- INSERT INTO ModifierArguments
		-- (ModifierId,						Name,						Value)
-- SELECT	'VICTORIA_PRODUCTION_MILLS_JNR',	Name,						Value
-- FROM	ModifierArguments
-- WHERE	ModifierId='VICTORIA_PRODUCTION_WORKSHOP' AND Name='YieldType';

-- INSERT INTO ModifierArguments
		-- (ModifierId,						Name,						Value)
-- SELECT	'VICTORIA_PRODUCTION_MILLS_JNR',	Name,						Value
-- FROM	ModifierArguments
-- WHERE	ModifierId='VICTORIA_PRODUCTION_WORKSHOP' AND Name='Amount';

-- INSERT INTO ModifierArguments
		-- (ModifierId,						Name,						Value)
-- SELECT	'VICTORIA_PRODUCTION_PRODUCT_JNR',	Name,						Value
-- FROM	ModifierArguments
-- WHERE	ModifierId='VICTORIA_PRODUCTION_WORKSHOP' AND Name='YieldType';
...
-- INSERT OR IGNORE INTO TraitModifiers
		-- (TraitType,	ModifierId)
-- SELECT	TraitType,	'VICTORIA_PRODUCTION_MILLS_JNR'
-- FROM	TraitModifiers
-- WHERE	TraitType='TRAIT_LEADER_VICTORIA_ALT' AND ModifierId='VICTORIA_PRODUCTION_WORKSHOP';

-- INSERT OR IGNORE INTO TraitModifiers
		-- (TraitType,	ModifierId)
-- SELECT	TraitType,	'VICTORIA_PRODUCTION_PRODUCT_JNR'
-- FROM	TraitModifiers
-- WHERE	TraitType='TRAIT_LEADER_VICTORIA_ALT' AND ModifierId='VICTORIA_PRODUCTION_WORKSHOP';
-- --------------------------------------------------------------
