...
VALUES	('JNR_ALLINDUSTRIAL_BASE_TRADEROUTE_DOMESTIC_PRODUCTION',	'MODIFIER_SINGLE_CITY_ADJUST_TRADE_ROUTE_YIELD_TO_OTHERS');
--------------------------------------------------------------
...
VALUES	('JNR_ALLINDUSTRIAL_BASE_TRADEROUTE_DOMESTIC_PRODUCTION',	'Amount',		1),
		...
		('JNR_ALLINDUSTRIAL_BASE_TRADEROUTE_DOMESTIC_PRODUCTION',	'Domestic',		1);
--------------------------------------------------------------
...
VALUES	('BUILDING_JNR_IZ_WATER_MILL',			'JNR_ALLINDUSTRIAL_BASE_TRADEROUTE_DOMESTIC_PRODUCTION'),
