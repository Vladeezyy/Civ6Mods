...
VALUES	('BUILDING_JNR_MILL_RACE',			'DISTRICT_CITY_CENTER',		NULL,					0,		0,				0,				NULL,			'ADVISOR_GENERIC',	'LOC_BUILDING_JNR_MILL_RACE_NAME',			'LOC_BUILDING_JNR_MILL_RACE_DESCRIPTION'),
		('BUILDING_JNR_IZ_WATER_MILL',		'DISTRICT_INDUSTRIAL_ZONE',	'TECH_CONSTRUCTION',	150,	1,				1,				'YIELD_GOLD',	'ADVISOR_GENERIC',	'LOC_BUILDING_WATER_MILL_NAME',				'LOC_BUILDING_JNR_IZ_WATER_MILL_DESCRIPTION'),
...
UPDATE Buildings SET MustPurchase=1 WHERE BuildingType='BUILDING_JNR_MILL_RACE';

UPDATE Buildings SET																Name='LOC_BUILDING_JNR_IRRIGATION_WHEEL_NAME'								WHERE BuildingType='BUILDING_WATER_MILL';
...
UPDATE Buildings SET PrereqTech='TECH_MASS_PRODUCTION',	Cost=250,	Maintenance=2,	Description='LOC_BUILDING_JNR_DRAGON_KILN_DESCRIPTION_UC'					WHERE BuildingType='BUILDING_JNR_DRAGON_KILN';
...
SELECT	BuildingType,				'BUILDING_JNR_MANUFACTURY'
FROM	Buildings
WHERE	BuildingType='BUILDING_JNR_DRAGON_KILN';
...
VALUES	('BUILDING_JNR_MILL_RACE',		0);
...
VALUES	('BUILDING_JNR_MILL_RACE',			'BUILDING_JNR_DUMMY_PREREQ'),
		('BUILDING_JNR_IZ_WATER_MILL',		'BUILDING_JNR_MILL_RACE'),
		
		('BUILDING_WORKSHOP',				'BUILDING_JNR_IZ_WATER_MILL'),
		('BUILDING_JNR_MANUFACTURY',		'BUILDING_JNR_IZ_WATER_MILL'),
...
INSERT OR IGNORE INTO BuildingPrereqs
		(Building,							PrereqBuilding)
SELECT	BuildingType,						'BUILDING_JNR_IZ_WATER_MILL'
FROM	Buildings
WHERE	BuildingType='BUILDING_JNR_DRAGON_KILN';
...
WHERE	PrereqBuilding='BUILDING_JNR_IZ_WATER_MILL';
...
VALUES	('BUILDING_JNR_IZ_WATER_MILL',			'BUILDING_JNR_WIND_MILL'),
...
DELETE FROM MutuallyExclusiveBuildings WHERE Building='BUILDING_JNR_DRAGON_KILN' AND MutuallyExclusiveBuilding='BUILDING_JNR_MANUFACTURY';
--------------------------------------------------------------
...
INSERT OR IGNORE INTO CivilopediaPageExcludes
		(SectionId,		PageId)
VALUES	('BUILDINGS',	'BUILDING_JNR_MILL_RACE');
--------------------------------------------------------------