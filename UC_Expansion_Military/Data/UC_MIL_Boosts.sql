...
VALUES	('BUILDING_JNR_CASEMATES',	'ALT_GUNPOWDER_TECHBOOST_JNR'),
		('BUILDING_JNR_DEPOT',		'ALT_GUNPOWDER_TECHBOOST_JNR');
--------------------------------------------------------------
...
VALUES	('ALT_GUNPOWDER_TECHBOOST_JNR',	'MODIFIER_PLAYER_GRANT_SPECIFIC_TECH_BOOST',	1,			1);
--------------------------------------------------------------
...
VALUES	('ALT_GUNPOWDER_TECHBOOST_JNR',	'TechType',	'TECH_GUNPOWDER');
--------------------------------------------------------------