...
VALUES	('ICON_BUILDING_JNR_TARGET_RANGE',			'ICON_ATLAS_JNR_UC_MIL_BUILDINGS',		2),
		...
		('ICON_BUILDING_JNR_CASEMATES',				'ICON_ATLAS_JNR_UC_MIL_BUILDINGS',		5),
		...
		('ICON_BUILDING_JNR_ORDNANCE_BOARD',		'ICON_ATLAS_JNR_UC_MIL_BUILDINGS',		9),
		...
		('ICON_BUILDING_JNR_CASEMATES_FOW',			'ICON_ATLAS_BUILDINGS_FOW',				21),
		('ICON_BUILDING_JNR_DEPOT_FOW',				'ICON_ATLAS_BUILDINGS_FOW',				21),
		('ICON_BUILDING_JNR_ORDNANCE_BOARD_FOW',	'ICON_ATLAS_BUILDINGS_FOW',				29),
