...
--------------------------------------------------------------
UPDATE LocalizedText SET Text=REPLACE(Text, 'University',			'University or Academy')								WHERE Tag =	  'LOC_IDENTITY_SUK_OPEN_SKIES_DESCRIPTION';
UPDATE LocalizedText SET Text=REPLACE(Text, 'University',			'University/Academy')									WHERE Tag =	  'LOC_IDENTITY_SUK_FOSSIL_DEPOSITS_DESCRIPTION';
--------------------------------------------------------------
