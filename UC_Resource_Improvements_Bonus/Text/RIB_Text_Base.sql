...
VALUES	('LOC_JNR_RIB_BANANAS_RESOURCE_SET',							'[ICON_RESOURCE_BANANAS] Bananas'),
		...
		('LOC_GOVERNOR_PROMOTION_JNR_RESOURCEFULNESS_NAME',				'Resourcefulness'),
		('LOC_GOVERNOR_PROMOTION_JNR_RESOURCEFULNESS_DESCRIPTION',		'Bonus resource bonuses are available in this city without the respective resource.'),
		...
		('LOC_IMPROVEMENT_JNR_RIB_DUMMY_DEER_DESCRIPTION',				'+2 [ICON_AMENITIES] Amenities in cities with at least 1 improved {LOC_JNR_RIB_DEER_RESOURCE_SET} resource and a National Park.'),
		('LOC_IMPROVEMENT_JNR_RIB_DUMMY_DEER_DESCRIPTION_PRESERVE',		'+1 [ICON_AMENITIES] Amenities from Preserve districts in cities with at least 1 improved {LOC_JNR_RIB_DEER_RESOURCE_SET} resource.[NEWLINE]+1 [ICON_AMENITIES] Amenities in cities with at least 1 improved {LOC_JNR_RIB_DEER_RESOURCE_SET} resource and a National Park.'),
		('LOC_IMPROVEMENT_JNR_RIB_DUMMY_DEER_DESCRIPTION_GARDEN',		'+1 [ICON_AMENITIES] Amenities from Garden districts in cities with at least 1 improved {LOC_JNR_RIB_DEER_RESOURCE_SET} resource.[NEWLINE]+1 [ICON_AMENITIES] Amenities in cities with at least 1 improved {LOC_JNR_RIB_DEER_RESOURCE_SET} resource and a National Park.'),
		('LOC_IMPROVEMENT_JNR_RIB_DUMMY_DEER_DESCRIPTION_GREENERY',		'+1 [ICON_AMENITIES] Amenities from Preserve and Garden districts in cities with at least 1 improved {LOC_JNR_RIB_DEER_RESOURCE_SET} resource.[NEWLINE]+1 [ICON_AMENITIES] Amenities in cities with at least 1 improved {LOC_JNR_RIB_DEER_RESOURCE_SET} resource and a National Park.'),
