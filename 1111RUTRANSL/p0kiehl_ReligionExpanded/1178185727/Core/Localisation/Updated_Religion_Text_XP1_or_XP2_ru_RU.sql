--=============================================================================================================
-- RELIGION EXPANDED: UPDATED RELIGION TEXT (XP1 OR XP2)
--=============================================================================================================
...
-- Founder Beliefs
--------------------------------------------------------------------------------------------------------------- 
		('ru_RU',	'LOC_BELIEF_PAPAL_PRIMACY_DESCRIPTION', 
		'Отправка [ICON_Envoy] посла в город-государство оказывает +200 [ICON_Religion] религиозного влияния на этот город-государство.');
